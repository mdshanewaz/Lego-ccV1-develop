...
def send_email_customized(subject, plain_message_text, html_message_text, to_emails_list, appname):
    if appname == 'AUTH':
    ...
    elif appname == 'PRODSERV':
        from_email          = settings.EMAIL_CONFIG["PRODSERV"]["EMAIL_HOST_USER"]
