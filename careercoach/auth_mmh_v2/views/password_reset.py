...
TEMP_DIR_EMAIL          = 'commonroom/email/auth/pass_reset/'
    ...
    if request.method == "GET":
        ...
        if form.is_valid():
            ...
            if not user_qs.exists():
                ...
                form_error = "We didnot find any account with this email address"
                ...
                html_message_text = render_to_string(
                    template_name=TEMP_DIR_EMAIL + 'template2.html',
                ...
                return HttpResponseRedirect(reverse_lazy('auth_mmh_v2:password_reset_done'))
