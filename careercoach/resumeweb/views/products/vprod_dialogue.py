...
PATH_PRODUCT_LAYOUT     = "resumeweb/layout/products/3-dialogue/"
PATH_ROOT               = os.path.join(settings.BASE_DIR)
PATH_PRODUCT_COMPONENT  = 'resumeweb/templates/resumeweb/components/products/dialogue'

PRODUCT_LINE        = 'dialogue'
PRODUCT_SLOGAN      = 'add slogan hereidentity'
MODEL_PRODUCT       = mprod_intprep
MODEL_PRODUCT_CAT   = mprod_intprep_catlist


# homepage
# ******************************************************************************
class IntPrepHome(ListView):
...
# all services
# ******************************************************************************
class IntPrepServiceAll(ListView):
...
# by cat 
# ******************************************************************************
class IntPrepServiceByCat(ListView):
    template_name = PATH_PRODUCT_LAYOUT + "all_serv.html"
    model = MODEL_PRODUCT
...
def populate_cardDetailViewClass():
    product_model_name              = "mprod_intprep"
    ...
    breadcrumb_url_name             = "intprep_all_services"     # Name of django view that is used for breadcrumb url for this product
...
# ******************************************************************************
def IntPrepProdDetails_ajax(request, id):
    zzz_print("    %-28s: %s" % ("IntPrepProdDetails_ajax (id)", id))
...
# ******************************************************************************
def IntPrepProdDetails(request, id):
...
# ******************************************************************************
class IntPrepTerms(TemplateView):
    template_name = PATH_PRODUCT_LAYOUT + "terms-cond.html"


# our speciality
# ******************************************************************************
class IntPrepOurspeciality(TemplateView):
...
# how it works
# ******************************************************************************
class IntPrepHowItWorks(TemplateView):
    template_name = PATH_PRODUCT_LAYOUT + "prod_ins_pg.html"
...
# ******************************************************************************
class IntPrepCompareThis(TemplateView):
...
# ******************************************************************************
class IntPrepUseCases(TemplateView):
    template_name = PATH_PRODUCT_LAYOUT + "prod_ins_pg.html"
...
# ******************************************************************************
class IntPrepProductDeliveryMethods(TemplateView):
    template_name = PATH_PRODUCT_LAYOUT + "prod_ins_pg.html"
