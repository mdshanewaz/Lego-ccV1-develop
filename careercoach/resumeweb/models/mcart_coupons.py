...
class mcart_coupons(models.Model):
    ...
    mcart                           = models.OneToOneField  ('resumeweb.mcart', on_delete=models.CASCADE)
    mcoupon_given                   = models.OneToOneField  ('resumeweb.mcoupon_given', on_delete=models.CASCADE)
