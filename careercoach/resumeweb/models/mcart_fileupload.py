...
class mcart_uploadpath(object):
    ...
    def deconstruct(self):
        kwargs = {}
        return 'resumeweb.models.mcart_uploadpath', (), kwargs
    # --------------------------------------------------------------------------
    def __call__(self, instance, filename):
        ...
        return "{}/{}_{}_{}".format(os.environ.get('MCART_RESUME_FOLDER'),instance.owner_uniqid, instance.created, filename)
...
class mcart_fileupload(models.Model):
    ...
    def get_full_media_path_and_filename(self):
        return_text = settings.MEDIA_ROOT + "/" + str(self.document)
        return return_text
