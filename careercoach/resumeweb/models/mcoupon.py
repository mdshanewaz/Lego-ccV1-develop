...
class mcoupon(models.Model):
    product_liked       = models.CharField      (max_length=20, choices=const_resumeweb.CATEGORYNAME_DISPLAYNAME_TUPLE_ALL_COUPONS, blank=False, null=False, default='mprod_exp180')
