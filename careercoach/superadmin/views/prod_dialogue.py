...
# mprod_intprep_catlist
########################################################################################
@admin.register(mprod_intprep_catlist)
class admin_mprod_intprep_catlist(admin.ModelAdmin):
    list_display = (
        "id",
        "catname"
    )
...
########################################################################################
@admin.register(mprod_intprep)
class AdminIntprepServList(admin.ModelAdmin):
    list_display = (
        "sku",
        "title",
        "category",
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        formfield = super(AdminIntprepServList, self).formfield_for_dbfield(db_field, **kwargs)
...
## service options
## *****************************************************************************************
@admin.register(mprod_intprep_serviceoption)
class AdminIntprepServiceoption(admin.ModelAdmin):
    list_display = (
        "sku",
        "name",
        "listprice",
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        formfield = super(AdminIntprepServiceoption, self).formfield_for_dbfield(db_field, **kwargs)
...
## delivery options
## *****************************************************************************************
@admin.register(mprod_intprep_deliveryoption)
class admin_mprod_intprep_deliveryoption(admin.ModelAdmin):
    list_display = (
        "name",
        "sku",
        "listprice",
