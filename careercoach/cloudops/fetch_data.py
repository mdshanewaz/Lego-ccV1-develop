...
def fetch_data_faq(product_line):
    ...
    FILE_TO_READ = 'ccv1-static-data/faq/product/' + product_line.lower() + '.json'
...
def fetch_data_ta(product_line):
    ...
    bucket_name = 'cdr-108'
    file_path = 'ccv1-static-data/target-audiances/ta.json'
...
def fetch_data_impfact(product_line):
    ...
    # Define the S3 bucket and file path
    bucket_name = 'cdr-108'
    file_path = 'ccv1-static-data/impact-factors/factor-values.json'
