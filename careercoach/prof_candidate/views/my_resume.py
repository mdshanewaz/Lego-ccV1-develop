...
class ResumeDocView(LoginRequiredMixin, CreateView): 
    ...
    def form_valid(self, form):
        ...
        subject = "Resume File Uploaded Successfully"
...
def delete_doc(request, doc_id):
    ...
    subject = "Resume File Deleted Successfully"
...
class ResumeFormEditView(LoginRequiredMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        self.object.save()
        subject = "Resume Information Updated Successfully"
