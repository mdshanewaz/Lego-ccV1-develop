...
from django.views.generic.edit import CreateView
# ******************************************************************************
class OrderCancellationRequestView(CreateView):
...
# ******************************************************************************
class OrderCancellationDetailsView(DetailView):
    template_name   = TEMPLATE_DIR + 'view_request.html'
    model           = OrderCancellationRequest

    def get_context_data(self, **kwargs):
        context = super(OrderCancellationDetailsView, self).get_context_data(**kwargs)
...
def CancelOrder_mmh(request, tracking_id):
    ...
    form_html = render_to_string(
        template_name = "prof_candidate/pg-contents/order_cancellation/mmh_tform.html", 
